...
# numeric maxima (fall back to sensible caps if empty)
...
with st.sidebar:
    ...
    # NEW: Range sliders for X/Y metrics (top)
    ...
    # Existing tech skill range sliders
