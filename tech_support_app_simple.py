...
# Check candidate name column
candidate_col = "Candidate Name" if "Candidate Name" in df.columns else None
...
if candidate_col:
    tooltip_fields.insert(0, alt.Tooltip(f"{candidate_col}:N", title="Candidate"))
